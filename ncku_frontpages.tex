...
\newcommand\Location{61204~教室}
\newcommand\Date{2017.12.21（四）~13：10~14：00}
...
\large
	...
	\vspace{1cm}
    \makebox[3cm][c]{\Huge{\topic}}\\ %顯示中文系所名
	\vspace{1.8cm}
	\end{minipage}%
\\
...
\renewcommand{\baselinestretch}{1.3}   %行距 1 倍
...
%\vfill
%[10cm][s]{\Large{中華民國\cYear 年\cMonth 月\cDay 日}}%
%

\hspace{3cm}
\begin{tabular}{rcl}
\hspace{3cm}\LARGE{研 究 生} & \LARGE{:} & \LARGE{\myCname}\\
\hspace{3cm}\LARGE{審查委員} & \LARGE{:} & \LARGE{\advisorCnameA}\\
\hspace{3cm} &  & \LARGE{\advisorCnameB}\\
\hspace{3cm} &  & \LARGE{\advisorCnameC}\\
\hspace{3cm}\LARGE{地點} & \LARGE{:} & \LARGE{\Location}\\
\hspace{3cm}\LARGE{日期} & \LARGE{:} & \LARGE{\Date}\\
\end{tabular}
\end{center}
